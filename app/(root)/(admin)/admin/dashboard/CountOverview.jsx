  ...
  return (
    <div className='grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5'>
        <Link href={ADMIN_CATEGORY_SHOW}>
            <div className='flex justify-between items-center p-3 rounded-lg shadow border border-l-green-400
                bg-white dark:bg-card dark:border-gray-800 dark:border-l-green-400'>
                <div>
        ...
        <Link href={ADMIN_PRODUCT_SHOW} >
            <div className='flex justify-between items-center p-3 rounded-lg shadow border border-l-blue-400
                bg-white dark:bg-card dark:border-gray-800 dark:border-l-blue-400'>
                <div>
        ...
        <Link href={ADMIN_CUSTOMERS_SHOW} >
            <div className='flex justify-between items-center p-3 rounded-lg shadow border border-l-yellow-400
                bg-white dark:bg-card dark:border-gray-800 dark:border-l-yellow-400'>
                <div>
        ...
        <Link href='' >
            <div className='flex justify-between items-center p-3 rounded-lg shadow border border-l-cyan-400
                bg-white dark:bg-card dark:border-gray-800 dark:border-l-cyan-400'>
                <div>

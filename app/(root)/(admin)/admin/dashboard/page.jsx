  ...
  return (
    <div className='pt-5'>
        ...
        <div className=' mt-10 flex lg:flex-nowrap flex-wrap gap-10'>
            <Card className={'w-full rounded-lg lg:w-[70%] p-0'}>
            ...
            <Card className={'w-full rounded-lg lg:w-[30%] p-0'}>
        ...
        <div className=' mt-10 flex lg:flex-nowrap flex-wrap gap-10'>
            <Card className={'w-full rounded-lg lg:w-[70%] p-0 block'}>
              <CardHeader className='py-3 border [.border-b]: pb-3'>
                  <div className='flex justify-between items-center'>
            ...
            <Card className={'w-full rounded-lg lg:w-[30%] p-0 block'}>
              <CardHeader className='py-2'>
                  <div className='flex justify-between items-center'>
              ...
              <CardContent className='pt-3 lg:h-[350px] overflow-auto px-1'>
                    <LatestReview/>
              </CardContent>
            </Card>
        </div>

    ...
    <div>
      ...
      <UserPanelLayout>
        <div className='shadow rounded'>
              ...
              <div className='p-5'>
                  <Form {...form}>
                    <form className='grid md:grid-cols-2 grid-cols-1 gap-5 p-5' onSubmit={form.handleSubmit(updateProfile)}>
                        ...
                        <Dropzone onDrop={acceptedFiles => handleFileSelection(acceptedFiles)}>
                          {({getRootProps, getInputProps}) => (
                              ...
                              <div {...getRootProps()}>
                                ...
                                <Avatar className={'w-28 h-28 relative group border-gray-100'}>
                                  <AvatarImage src={preview ? preview : userIcon.src}/>
                                  <div className='absolute z-50 w-full h-full  inset-0
                                  justify-center items-center border-2 border-violet-500 rounded-full group-hover:flex hidden cursor-pointer bg-black/50'>
                      ...
                      <div className="mb-5 md:col-span-2 col-span-1">
                        <FormField
                        control={form.control}
                        name="address"
                        render={({ field }) => (

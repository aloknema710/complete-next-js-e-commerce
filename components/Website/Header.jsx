  ...
  return (
    <div className=' bg-white border-b lg:px-32 px-4'>
        <div className=' flex justify-between items-center lg:py-5 py-3'>
            <Link href={WEBSITE_ROUTE.HOME}>
                <Image src={logo} alt="Logo" width={383} height={146} 
                    className=' lg:w-32 w-24'/>
            </Link>
            <div className=' flex justify-between gap-20'>
                {/* <nav> */}
                <nav className={`lg:relative lg:w-auto lg:h-auto lg:top-0 lg:left-0 lg:p-0 bg-white fixed z-50 top-0 w-full transition-all ${isMobileMenu ? 'left-0' : '-left-full'}`}>

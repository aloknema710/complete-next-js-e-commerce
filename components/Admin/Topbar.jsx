...
const Topbar = () => {
  ...
  return (
    <div className='fixed border w-full h-14 top-0 left-0 md:ps-72 z-30 md:pe-8 px-5 flex justify-between items-center bg-white dark:bg-card'>
        ...
        <div className='px-70 md:block hidden'>
            <AdminSearch/>
        </div>
        ...
        <div className=' flex items-center gap-2'>
            ...
            <ThemeSwitch/>
            <UserDropdown/>
            <Button onClick={toggleSidebar} type='button' size='icon' className='ms-2 '>
                <RiMenu4Fill/>
            </Button>
        </div>
    </div>

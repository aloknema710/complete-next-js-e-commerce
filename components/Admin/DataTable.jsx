...
// import { DeleteForeverIcon, RestoreFromTrashIcon, SaveAltIcon } from '@mui/icons-material'
import useDeleteMutation from '@/hooks/useDeleteMutation'
import ButtonLoading from '../Application/ButtonLoading'
import { showToast } from '@/lib/showToast'
import { download, generateCsv, mkConfig } from 'export-to-csv'
import { DeleteForever, RestoreFromTrash, SaveAlt } from '@mui/icons-material'
                ...
                <>
                    ...
                    {deleteType!=='PD' &&
                        <Tooltip title='Recycle Bin'>
                            <Link href={trashView}>
                                <IconButton> <RecyclingIcon/> </IconButton>
                            </Link>
                        </Tooltip>
                    }    
                    {deleteType === 'SD'&&

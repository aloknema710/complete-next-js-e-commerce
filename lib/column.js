...
export const DT_COUPON_COLUMN = [
    ...
    },
    {
        ...
        Cell: ({ renderedCellValue }) => {
            ...
            return isExpired 
                ? <Chip color="error" label={renderedCellValue} />
                : <Chip color="success" label={renderedCellValue} />;
        }
    },
]
...
//         Cell: ({ renderedCellValue }) =>{
//             const date = new Date(renderedCellValue);
//             new Date() > new Date(renderedCellValue) ? <Chip color="error" label={renderedCellValue} /> : <Chip color="success" label={renderedCellValue} />
//         }
//     },
// ]
